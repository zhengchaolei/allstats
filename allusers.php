...
if($sortcat == "name")
{
	...
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=200px><a href=\"?p=allusers&s=name&o=desc&n=".$sortoffset."\">Name</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=200px><a href=\"?p=allusers&s=name&o=asc&n=".$sortoffset."\">Name</a></td>");
	}
}
else
{
