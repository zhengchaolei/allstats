...
if($sortcat == "description")
{
	if($order == "asc")
	{
		print("<td width=145px class=\"headercell\" colspan=2><a href=\"?p=userheroall&u=".$username."&s=description&o=desc&n=".$sortoffset."\">Hero</a></td>");
	}
	else
	{
		print("<td width=145px class=\"headercell\" colspan=2><a href=\"?p=userheroall&u=".$username."&s=description&o=asc&n=".$sortoffset."\">Hero</a></td>");
	}
}
else
{
...
if($sortcat == "totgames")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=totgames&o=desc&n=".$sortoffset."\">Times<br>Played</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=totgames&o=asc&n=".$sortoffset."\">Times<br>Played</a></td>");
	}
}
else
{
...
if($sortcat == "wins")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=wins&o=desc&n=".$sortoffset."\">Wins</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=wins&o=asc&n=".$sortoffset."\">Wins</a></td>");
	}
}
else
{
...
if($sortcat == "losses")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=losses&o=desc&n=".$sortoffset."\">Losses</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=losses&o=asc&n=".$sortoffset."\">Losses</a></td>");
	}
}
else
{
...
if($sortcat == "winratio")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=winratio&o=desc&n=".$sortoffset."\">Win/Loss<br>Ratio</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=winratio&o=asc&n=".$sortoffset."\">Win/Loss<br>Ratio</a></td>");
	}
}
else
{
...
if($sortcat == "kills")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=kills&o=desc&n=".$sortoffset."\">Kills</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=kills&o=asc&n=".$sortoffset."\">Kills</a></td>");
	}
}
else
{
...
if($sortcat == "deaths")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=deaths&o=desc&n=".$sortoffset."\">Deaths</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=deaths&o=asc&n=".$sortoffset."\">Deaths</a></td>");
	}
}
else
{
...
if($sortcat == "assists")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=assists&o=desc&n=".$sortoffset."\">Assists</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=assists&o=asc&n=".$sortoffset."\">Assists</a></td>");
	}
}
else
{
...
if($sortcat == "kdratio")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=kdratio&o=desc&n=".$sortoffset."\">K/D<br>Ratio</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=kdratio&o=asc&n=".$sortoffset."\">K/D<br>Ratio</a></td>");
	}
}
else
{
...
if($sortcat == "creepkills")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=creepkills&o=desc&n=".$sortoffset."\">Creep<br>Kills</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=creepkills&o=asc&n=".$sortoffset."\">Creep<br>Kills</a></td>");
	}
}
else
{
...
if($sortcat == "creepdenies")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=creepdenies&o=desc&n=".$sortoffset."\">Creep<br>Denies</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=creepdenies&o=asc&n=".$sortoffset."\">Creep<br>Denies</a></td>");
	}
}
else
{
...
if($sortcat == "neutralkills")
{
	if($order == "asc")
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=neutralkills&o=desc&n=".$sortoffset."\">Neutral<br>Kills</a></td>");
	}
	else
	{
		print("<td class=\"headercell\" width=75px><a href=\"?p=userheroall&u=".$username."&s=neutralkills&o=asc&n=".$sortoffset."\">Neutral<br>Kills</a></td>");
	}
}
else
{
