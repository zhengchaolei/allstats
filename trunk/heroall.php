...
<div id="datawrapper">
	...
	(SELECT description, original, count(*) as totgames, 
	...
	FROM dotaplayers AS a LEFT JOIN originals as b ON hero = original LEFT JOIN dotagames as c ON c.gameid = a.gameid 
